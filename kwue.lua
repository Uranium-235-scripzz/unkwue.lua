...
adminversion = "RBXSKRIPZZ Admin by Uranium, Version 2.0"
...
CMDBAR.Text = "Run a command monkey"
...
lplayer.Chatted:Connect(function(msg)
    ...
    if string.sub(msg, 1, 8) == (prefix.."fecheck") then
        if game:GetService("Workspace").FilteringEnabled == true then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "FE is Enabled";
                Text = "Filtering Enabled. Enjoy using RBXSKRIPZZ Admin!";
            })
        else
...
CMDBAR.FocusLost:connect(function(enterPressed)
    if enterPressed then
        ...
        if string.sub(CMDBAR.Text, 1, 7) == ("carpet ") then
            for i,v in pairs(GetPlayer(string.sub(CMDBAR.Text, 8))) do
                local Anim3 = Instance.new("Animation")
                Anim3.AnimationId = "rbxassetid:/104923465585393"
                local track3 = lplayer.Character.Humanoid:LoadAnimation(Anim3)
                track3:Play(.1, 1, 1)
                bplrr = v.Name
                banpl = true
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    Text = "RBXSKRIPZZ Admin V2 by Uranium";
})
wait(0.1)
print("RBXSKRIPZZ Admin V2 loaded!")
if game:GetService("Workspace").FilteringEnabled == true then
    warn("FE is Enabled (Filtering Enabled)")
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "FE is Enabled";
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=104923465585393"
